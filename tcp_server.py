...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as a_server_socket:
    # bind this socket to OS
    a_server_socket.bind((HOST, PORT))

    # set listening mode on for this socket
    a_server_socket.listen()
    ...
    while True:
        ...
        client_socket, (client_addr, client_port) = a_server_socket.accept()
